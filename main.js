...
listaDivisas.push(new Divisa("USD $", "Dólar", 192.50, 300));
listaDivisas.push(new Divisa("EUR €", "Euro", 180.30, 302.70));
listaDivisas.push(new Divisa("BRL R$", "Real", 39.10, 59.60));
listaDivisas.push(new Divisa("CLP $", "Peso Chileno", 0.2210, 0.3358));
listaDivisas.push(new Divisa("$U", "Peso Uruguayo", 4.66, 6.06));
...
function calcularCambioCompra(nombreDivisa, tasaCambio) {
    ...
    console.log("El detalle de la operación es: \n" + "AR $ " + subTotalCompra.toString() + " + 30% de Impuesto País + 35% de Impuesto la Ganancia");
